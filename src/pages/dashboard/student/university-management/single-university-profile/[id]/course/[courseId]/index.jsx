...
const SingleUniversityCourse = () => {
  ...
  const startDate = new Date(getSingleCourseData?.data?.accommodation_start_date);
  ...
  const tuitionFee = getSingleCourseData?.data?.tution_fee || getSingleCourseData?.data?.university_price;
  
  const scholarshipPercentage = tuitionFee > 0 ? Math.round((scholarshipAmount / tuitionFee) * 100) : 0;
              ...
              <>
                {step === 1 ? (
                        ...
                        Institute of Accountants.`}
                            ...
                            <div className="d-flex gap-4 flex-wrap">
                              ...
                              <div className="program-duration course-act">
                                ...
                                <b>
                                  Tuition Fee:{' '}
                                  {getSingleCourseData?.data?.university_price} {'MYR'}
                                </b>{' '}
                              </div>

                              <div className="program-duration course-act" style={{ lineHeight: '17px' }}>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="23"
                                  height="20"
                              ...
                              <div className="program-duration course-act" style={{ lineHeight: '17px' }} >
                                ...
                                <b>
                                  Balance Payable: {(getSingleCourseData?.data?.university_price || 0) - (getSingleCourseData?.data?.price || 0)} MYR
                                  <br />
                                  <span style={{ fontSize: '12px' }}>
                          ...
                          <div className="course-details">
                            ...
                            <div class="course-offers">
                                  ...
                                  {getSingleCourseData?.data?.free_accommodation && (
                                    ...
                                    <li>
                                      <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M14.0927 9.88828H5.64865C4.3218 9.88828 3.65839 9.88827 3.24618 10.3005C2.83398 10.7127 2.83398 11.3761 2.83398 12.7029V14.1103C2.83398 15.4371 2.83398 16.1005 3.24618 16.5127C3.65839 16.925 4.3218 16.925 5.64865 16.925H7.05599H14.0927V9.88828ZM7.05599 19.7396V25.369C7.05599 26.6958 7.05599 27.3592 7.46818 27.7714C7.88039 28.1836 8.54381 28.1836 9.87066 28.1836H14.0927V19.7396H7.05599ZM16.9073 28.1836H21.1293C22.4562 28.1836 23.1196 28.1836 23.5318 27.7714C23.944 27.3592 23.944 26.6958 23.944 25.369V19.7396H16.9073V28.1836ZM23.944 16.925H25.3513C26.6782 16.925 27.3416 16.925 27.7538 16.5127C28.166 16.1005 28.166 15.4371 28.166 14.1103V12.7029C28.166 11.3761 28.166 10.7127 27.7538 10.3005C27.3416 9.88827 26.6782 9.88828 25.3513 9.88828H16.9073V16.925H23.944Z" fill="#13C9BF"></path>
                                        <path d="M25.3513 5.14904V4.89275C25.3513 3.19624 23.6893 1.9983 22.0799 2.53479C20.0665 3.20591 18.2371 4.33656 16.7365 5.8372L15.5 7.07363V8.48097H20.6725C20.9751 8.48097 21.2757 8.43219 21.5627 8.33653L23.5255 7.68225C24.6159 7.31879 25.3513 6.29839 25.3513 5.14904Z" fill="#13C9BF"></path>
                                        <path d="M5.64844 5.14904V4.89275C5.64844 3.19624 7.31049 1.9983 8.91993 2.53479C10.9333 3.20591 12.7627 4.33656 14.2633 5.8372L15.4998 7.07363V8.48097H10.3272C10.0247 8.48097 9.72412 8.43219 9.43712 8.33653L7.47427 7.68225C6.3839 7.31879 5.64844 6.29839 5.64844 5.14904Z" fill="#13C9BF"></path>
                                      </svg>
                                      <span> {accommodationShow} free accommodation</span>
                                    </li>
                                  ...
                                  {getSingleCourseData?.data?.free_accessories && (
                                    ...
                                    <li>
                                      <svg xmlns="http://www.w3.org/2000/svg" width="37" height="31" viewBox="0 0 37 31" fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M31.8258 25.5319C29.419 25.5319 8.14698 25.8597 5.5188 25.8597C2.89061 25.8597 2.52637 24.1169 2.52637 22.0407C3.11196 22.0407 9.00436 22.0827 15.3703 22.1332C15.3703 23.3912 15.4767 23.4108 18.4075 23.4108C21.3383 23.4108 21.4112 23.3464 21.4112 22.178C27.3596 22.2228 33.1539 22.2593 34.4736 22.2593C34.468 23.5706 34.0561 25.5319 31.8258 25.5319ZM5.76817 21.0152C5.76817 20.99 5.57483 9.07072 5.60846 7.62494C5.64768 5.72805 6.19686 5.12564 7.84998 5.12564C9.17247 5.12564 26.9589 5.15646 28.6569 5.19289C30.5902 5.23211 30.8676 6.14273 30.8676 7.89952C30.8676 9.17999 30.5202 20.8247 30.5202 20.8247L5.76817 21.0152Z" fill="#13C9BF"></path>
                                      </svg>
                                      {getSingleCourseData?.data?.accessories.length > 0 && getSingleCourseData.data.accessories.some(item => item.trim() !== "") ? (
                                        getSingleCourseData.data.accessories.map((item, index) => (
                                          item.trim() !== "" && (
                                            <span key={index}>
                                              {item.charAt(0).toUpperCase() + item.slice(1)}
                                              {index < getSingleCourseData.data.accessories.length - 1 && ", "}
                                            </span>
                                          )
                                        ))
                                      ) : (
                              ...
                              {(getSingleCourseData?.data?.free_air_ticket ||
                                ...
                                getSingleCourseData?.data?.free_accommodation ||
                                (getSingleCourseData?.data?.free_accessories)) && (
                                  <div class="terms-conditions">* <span>Terms &amp; Conditions Apply</span>
                                  </div>
                                )}
                            </div>
                          </div>
                  ...
                  <AppliedCourseForm
                    ...
                    emgsfee={getSingleCourseData?.data?.price}
