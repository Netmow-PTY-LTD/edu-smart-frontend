...
const SingleCoursePageInFrontSite = () => {
  ...
  const scholarship_percentage = Math.round(
    (scholarship_amount * 100) / tuition_fee
  );
  return (
    <UniversityLayout>
                  ...
                  <div className="pe-lg-5">
                    ...
                    <div className="d-flex gap-4 flex-wrap">
                      ...
                      <div className="university-fees course-act">
                        ...
                        <b>Tuition Fee: {university_price || ''} MYR</b>{' '}
                      </div>
                      ...
                      <div className="course-offers">
                        ...
                        <div className="course-offers-list">
                          <ul>
                                ...
                                <li>
                                  ...
                                  <span>
                                    {(() => {
                                      ...
                                      const monthText =
                                        monthDifference > 0
                                          ? `${monthDifference} ${monthDifference > 1 ? 'months' : 'month'}`
                                          : '';

                                      return `${monthText} ${dayDifference} ${dayDifference > 1 ? 'days' : 'day'} free accommodation`;
                                    })()}
                                  </span>
                                </li>
                              )}

                            {tuition_fee && scholarship_amount && (
                              <li>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="30"
                            ...
                            {free_accessories && accessories?.length > 0 && (
                              <li>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="37"
