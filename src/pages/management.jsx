...
//its for malaysia
  ...
  {
    name: `Meghla Akter Mitu`,
    designation: 'Asst Director (Marketing)',
    contact: '+8801409027166',
    email: 'info@edusmart.study',
    image: `https://edu-smart.sgp1.cdn.digitaloceanspaces.com/Meghla.jpg`
  },
    {
    ...
    {
    name: `Md Wakil Ahamed`,
    designation: `Executive (Int' Students affairs)`,
    contact: '+6 0147051337',
    email: 'info@edusmart.study',
    image: `https://edu-smart.sgp1.cdn.digitaloceanspaces.com/wakil.jpg`
  },];
...
//   <div className="container">
//     <h1 className="text-center mb-5" style={{ fontSize: '25px', fontWeight: '700', color: '#0c3c60' }}>
//       Meet Our Management Team (Bangladesh)
//     </h1>
//     <Row className="g-4">
//       {teamMembers.map((member, index) => (
//         <Col md={4} sm={6} xs={12} key={index}>
