...
const EmgsStatus = ({
  ...
  const filteredHeaders = studentApplicationsHeaders.filter(
    (header) => !excludedKeys.includes(header.key)
  );
              ...
              <CardBody>
                {updateApplicationStatusIsLoading ? (
                  ...
                  <CommonTableComponent
                    headers={[...filteredHeaders, EmgsStatusActionData]}
                    data={filteredData || []}
