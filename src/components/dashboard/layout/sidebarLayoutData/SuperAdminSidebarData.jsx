...
const SuperAdminSidebarData = () => {
  ...
  const menuItems = [
          ...
          childItems: [
            {
              ...
              icon: '',
              link: '/super_admin/universities/uni-management/all-university',
            ...
            },
            {
              ...
              label: 'All Course',
              icon: '',
              link: '/super_admin/universities/uni-management/all-course',
              parentId: 'uni-management',
            },
            {
              id: 'allcategory',
              label: 'All Category',
              icon: '',
              link: '/super_admin/universities/uni-management/all-category',
              parentId: 'uni-management',
            },
          ],
        },
    ...
    },
    {
      ...
      icon: 'ri-group-fill',
      link: '/super-admin/self-registered-students',
    },
    {
      id: 'students',
      label: 'By Agent Students',
      icon: 'ri-group-fill',
      link: '/super-admin/by-agent-students',
    },
  ];
