...
//import images
import product8 from '../../../public/assets/images/companies/img-1.png';
import gitbox from '../../../public/assets/images/giftbox.png';
import product10 from '../../../public/assets/images/products/img-10.png';
          ...
          <Card className="h-100 rounded-0">
            <CardBody className="p-0">
              ...
              <Card className="sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                <CardBody>
                  <Image priority={true} src={gitbox} alt="" />
                  <div className="mt-4">
