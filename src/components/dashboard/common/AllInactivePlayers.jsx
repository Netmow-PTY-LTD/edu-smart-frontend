...
const AllInactivePlayers = ({
  ...
  useEffect(() => {
    const filteredPlayers = data?.filter((item) => item?.status === 'inactive');
    setInactivePlayers(filteredPlayers);
  }, [data]);
...
export default AllInactivePlayers;
