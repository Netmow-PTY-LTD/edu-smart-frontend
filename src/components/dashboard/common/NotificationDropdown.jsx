...
//import images
import bell from '../../../../public/assets/images/svg/bell.svg';
            ...
            <div className="p-3">
              <Row className="align-items-center">
                ...
                <div className="col-auto dropdown-tabs">
                  <span className="badge bg-light-subtle text-black fs-13">
                    {' '}
                    4 New
                  </span>
                </div>
              ...
              <SimpleBar style={{ maxHeight: '300px' }} className="pe-2">
                  ...
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1">
                      <Link href="" className="stretched-link">
                        <h6 className="mt-0 mb-2 lh-base fs-3">
                ...
                <div className="text-reset notification-item d-block dropdown-item position-relative active">
                  <div className="d-flex">
                    <Image
                      priority={true}
                      src={avatar2 ? avatar2 : `${userDummyImage}`}
                ...
                <div className="text-reset notification-item d-block dropdown-item position-relative">
                  <div className="d-flex">
                    <Image
                      priority={true}
                      src={avatar8 ? avatar8 : `${userDummyImage}`}
                      className="me-3 rounded-circle avatar-xs"
                      alt="user-pic"
                    />
                    <div className="flex-grow-1">
                ...
                <div className="my-3 text-center">
                  <button
                    type="button"
                    className="btn btn-soft-success waves-effect fs-3 waves-light"
                  >
              ...
              <SimpleBar style={{ maxHeight: '300px' }} className="pe-2">
                <div className="text-reset notification-item d-block dropdown-item">
                  <div className="d-flex">
                    <Image
                      priority={true}
                      src={avatar3 ? avatar3 : `${userDummyImage}`}
                      className="me-3 rounded-circle avatar-xs"
                      alt="user-pic"
                    />
                    <div className="flex-grow-1">
                ...
                <div className="text-reset notification-item d-block dropdown-item">
                  <div className="d-flex">
                    <Image
                      priority={true}
                      src={avatar6 ? avatar6 : `${userDummyImage}`}
                      className="me-3 rounded-circle avatar-xs"
                      alt="user-pic"
                    />
                    <div className="flex-grow-1">
