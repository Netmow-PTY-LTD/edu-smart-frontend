import { chatContactData } from '@/utils/common/data/chat';
...
import userDummayImage from '../../../../public/assets/images/users/user-dummy-img.jpg';
            ...
            <TabPane tabId="1" id="chats">
              ...
              >
                <div className="d-flex align-items-center px-4 mb-2">
                  <div className="flex-grow-1">
                    <h4 className="mb-0 fs-8 text-muted text-uppercase">
                      Direct Messages
                    </h4>
                  </div>
                  <div className="flex-shrink-0 ">
                    <UncontrolledTooltip placement="bottom" target="addnewmsg">
                      <span className="fs-5">New Message</span>
                    </UncontrolledTooltip>
                ...
                <div className="d-flex align-items-center px-4 mt-4 pt-2 mb-2">
                  ...
                  <div className="flex-shrink-0">
                    <UncontrolledTooltip
                      ...
                      target="createnewmsg"
                    >
                      <span className="fs-5">Create group</span>
                    </UncontrolledTooltip>
                    <Button
                      color=""
                      id="createnewmsg"
                  ...
                  >
                    {channels?.map((channel, key) => (
                      <React.Fragment key={key}>
                        <li>
                          <Link href="" className="unread-msg-user">
                            <div className="d-flex align-items-center">
                              <div className="flex-shrink-0 chat-user-img online align-self-center me-2 ms-0">
                                <div className="avatar-xxs">
                ...
                <div className="sort-contact">
                  {(chatContactData || []).map((item, key) => (
                    <div className="mt-3" key={key}>
                      <div className="contact-list-title fs-2">
                        {item.title}
                      </div>
                      <ul
                        ...
                        {item.contacts.map((item, key) => (
                          <li key={key}>
                            <div className="d-flex align-items-center ">
                              ...
                              >
                                <p className="text-truncate contactlist-name mb-0 fs-3">
                                  {item.name}
                                </p>
                              </div>
                              <div className="flex-shrink-0">
                                <UncontrolledDropdown>
                                  ...
                                  >
                                    <i className="ri-more-2-fill fs-2" />
                                  </DropdownToggle>
            ...
            <div className="w-100 overflow-hidden  position-relative">
              <div className="position-relative">
                <div className="p-3 user-chat-topbar ">
                  <Row className="align-items-center justify-content-center mx-2 my-4">
                    <Col sm={4} xs={8}>
                      <div className="d-flex align-items-center">
