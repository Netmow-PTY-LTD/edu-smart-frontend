    ...
    <TemplateLayout>
      ...
      <div className="container">
        <div className="page-main-content">
          ...
          <p>
            The information provided by <b>Central Stars Basketball</b>{' '}
            (“Company”, “we”, “our”, “us”) on{' '}
            <b>http://centralstarsbasketball.com/</b> (the “Site”) is for
          ...
          <p>
            ...
            <Link href="https://policymaker.io/disclaimer/" target="_blank">
              Disclaimer
            </Link>{' '}
            ...
            <Link
              href="https://policymaker.io/disclaimer/"
              target="_blank"
              rel="noopener"
            >
          ...
          <p>
            ...
            Central Stars Basketball is not responsible for any errors or
          ...
          <p>
            In no event will Central Stars Basketball, its related partnerships
          ...
          <p>
            ...
            represent those of Central Stars Basketball or any of its staff or
          ...
          <p>
            ...
            http://centralstarsbasketball.com/ are the trademarks and logos of
            their respective owners. Any inclusion of such trademarks or logos
            does not imply or constitute any approval, endorsement or
            sponsorship of Central Stars Basketball by such owners.
          </p>
          <p>
            <b>CONTACT US</b>
          </p>
          <p>
            ...
            <b>Info@centralstarsbasketball.com</b>.
          </p>{' '}
        </div>
      </div>
    </TemplateLayout>
