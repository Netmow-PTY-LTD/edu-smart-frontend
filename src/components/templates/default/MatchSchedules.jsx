...
const MatchSchedules = ({ singleTeamData }) => {
  ...
  return (
    <section className="match-schedules">
      <div className="container">
        <div className="sec-heading">
          <h2 style={colorSecondary(themeData)}>Schedule of Matches</h2>
        </div>
            ...
            >
              ...
              <div className="match-fixture">
                <div className="team team1">
                  <div className="team-logo team1-logo">
                    <img
                      src="/template1/assets/img/team1_logo.png"
                      alt="Team Logo"
                    />
                  </div>
                  <h5 className="team-name">NEW ROMANS</h5>
                </div>
                ...
                <div className="team team2">
                  ...
                  <h5 className="team-name">TEXAS TITANS</h5>
                </div>
              </div>
              <div className="match-schedule">
                <div className="match-time">
                  ...
                  <div className="match-date"> 25 Feb 2023 | 20:00</div>
                </div>
                  ...
                  <div className="single-match">
                    <div className="match-info">
                      <div className="tm-logo">
                        <img
                          src="template1/assets/img/team-logo1.png"
                          alt="Team Logo"
                        />
                      </div>
                      <div className="tm-name">AC WOLVERINES</div>
                    </div>
                    <div className="number bg-primary">1</div>
                  </div>
                  <div className="single-match">
                    <div className="match-info">
                      <div className="tm-logo">
                        <img src="assets/img/team_logo2.png" alt="Team Logo" />
                      </div>
                      <div className="tm-name">AC FC FORNEY</div>
                    </div>
                    <div className="number bg-secondary">1</div>
                  </div>
                </div>
                <div className="single-result">
                  <div className="single-match">
                    <div className="match-info">
                      <div className="tm-logo">
                        <img src="assets/img/team-logo1.png" alt="Team Logo" />
                      </div>
                      <div className="tm-name">AC WOLVERINES</div>
                    </div>
                    <div className="number bg-primary">1</div>
                  ...
                  <div className="single-match">
                    ...
                    <div className="number bg-secondary">0</div>
                  </div>
                </div>
                <div className="single-result">
                  <div className="single-match">
                    ...
                    <div className="number bg-primary">0</div>
                  </div>
                  <div className="single-match">
                    <div className="match-info">
                      <div className="tm-logo">
