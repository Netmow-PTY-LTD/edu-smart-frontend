    ...
    <TemplateLayout>
      ...
      <div className="container">
        <div className="page-main-content">
          <h2>TERMS OF USE</h2>
          <p>Last updated: 2022-06-03</p>
          <p>
            1. <b>Introduction</b>
          </p>
          <p>
            Welcome to <b>Central Stars Basketball!</b>
          </p>
          <p>
            These Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at <b>http://centralstarsbasketball.com/</b>{' '}
            (together or individually “Service”) operated by{' '}
            <b>Central Stars Basketball</b>.
          </p>
          <p>
          ...
          <p>
            ...
            <b>Info@centralstarsbasketball.com</b> so we can try to find a
          ...
          <p>
            ...
            emailing at Info@centralstarsbasketball.com.
          </p>
          <p>
            3. <b>Purchases</b>
          </p>
          ...
          <p>
            ...
            cancel it or Central Stars Basketball cancels it. You may cancel
            your Subscription renewal either through your online account
            management page or by contacting Info@centralstarsbasketball.com
            customer support team.
          </p>
          <p>
            A valid payment method is required to process the payment for your
            subscription. You shall provide Central Stars Basketball with
            ...
            payment information, you automatically authorize Central Stars
            Basketball to charge all Subscription fees incurred through your
            account to any such payment instruments.
          </p>
          <p>
            Should automatic billing fail to occur for any reason, Central Stars
            Basketball reserves the right to terminate your access to the
          ...
          <p>
            Central Stars Basketball may, at its sole discretion, offer a
          ...
          <p>
            ...
            Trial, you will not be charged by Central Stars Basketball until
          ...
          <p>
            At any time and without notice, Central Stars Basketball reserves
          ...
          <p>
            Central Stars Basketball, in its sole discretion and at any time,
          ...
          <p>
            Central Stars Basketball will provide you with a reasonable prior
          ...
          <p>
            Central Stars Basketball has the right but not the obligation to
            monitor and edit all Content provided by users.
          </p>
          <p>
            In addition, Content found on or through this Service are the
            property of Central Stars Basketball or used with permission. You
          ...
          <p>
            ...
            property of Central Stars Basketball and its licensors. Service is
            ...
            product or service without the prior written consent of Central
            Stars Basketball.
          </p>
          <p>
          ...
          <p>
            ...
            email to Info@centralstarsbasketball.com, with the subject line:
          ...
          <p>
            ...
            Info@centralstarsbasketball.com.
          </p>
          <p>
          ...
          <p>
            ...
            Info@centralstarsbasketball.com or via third party sites and tools
          ...
          <p>
            ...
            that are not owned or controlled by Central Stars Basketball.
          </p>
          <p>
            Central Stars Basketball has no control over, and assumes no
          ...
          <p>
            ...
            <Link href="https://policymaker.io/" target="_blank" rel="noopener">
              PolicyMaker.io
            </Link>
          ...
          <p>
            ...
            laws of Australia, which governing law applies to agreement without
          ...
          <p>
            ...
            by email: <b>Info@centralstarsbasketball.com</b>.
          </p>{' '}
        </div>
      </div>
    </TemplateLayout>
